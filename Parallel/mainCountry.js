...
// Loading the data
d3.csv('./assets/ParallelCountry.csv', d => {
    ...
    return {
        ...
        const keystodraw = data.columns.filter(function(d) {
            return d !== "" && d !== "year" && d !== "continent" && d !== "country";
        });
        ...
        var colorScale = d3.scaleOrdinal()       
            .domain(["Anguilla","Antigua and Barbuda","Argentina","Aruba",   "Bahamas", "Barbados","Belize",  "Bolivia", "Brazil",  "Caribbean Netherlands" ,       "Cayman Islands","Chile",   "Colombia","Costa Rica","Cuba",    "Curacao", "Dominica","Dominican Republic", "Ecuador", "El Salvador", "Falkland Islands",   "French Guiana","Grenada", "Guadeloupe","Guatemala", "Guyana",  "Haiti",   "Honduras","Jamaica", "Martinique", "Mexico",  "Montserrat","Nicaragua","Panama",  "Paraguay", "Peru",    "Puerto Rico","Saint Kitts and Nevis","Saint Lucia","Saint Vincent and Grenadines", "Saint-Martin","Sint Maarten","Suriname","Trinidad and Tobago","Turks and Caicos Islands","United States","Uruguay", "Venezuela","Virgin Islands, U.S.",
                    "Bangladesh", "Cambodia","China" ,"India" ,"Indonesia" ,"Japan" ,"Laos" , "Malaysia" , "Mongolia" , "Myanmar" ,  "Nepal" ,"North Korea","Pakistan" , "Philippines", "South Korea", "Sri Lanka" ,"Taiwan" ,"Thailand" , "Vietnam",
                    "Angola" , "Benin" ,"Botswana" ,  "Burkina Faso" ,"Burundi" ,  "Cameroon" ,  "Central African Republic" ,"Chad" ,"Democratic Republic of Congo", "Djibouti" , "Equatorial Guinea" ,"Eritrea" ,"eSwatini" ,  "Ethiopia" ,  "Gabon" , "Gambia" , "Ghana" ,"Guinea" , "Guinea-Bissau" ,    "Ivory Coast" , "Kenya" ,"Lesotho" ,"Liberia" ,"Madagascar" ,"Malawi" , "Mali" ,"Mauritania" ,"Mozambique" ,"Namibia" ,"Niger" , "Nigeria" ,"Republic of Congo" ,"Rwanda" , "Senegal" ,"Sierra Leone" ,    "Somalia" ,"South Africa" ,"South Sudan" , "Tanzania" ,  "Togo" , "Uganda" , "Zambia" , "Zimbabwe",
                    "Albania" ,"Andorra" ,"Austria" ,"Bailiwick of Guernsey",  "Bailiwick of Jersey" ,"Belarus" , "Belgium" ,"Bosnia and Herzegovina", "Bulgaria" , "Croatia" ,"Cyprus" , "Czech Republic" ,"Denmark" ,"Estonia" ,"Faroe Islands" ,  "Finland" ,"France" , "Germany" , "Gibraltar" ,"Greece" , "Greenland" ,"Hungary" ,"Iceland" ,"Ireland" , "Isle of Man" ,"Italy" ,  "Kosovo" , "Latvia" , "Liechtenstein" ,  "Lithuania" , "Luxembourg" , "Malta" ,  "Moldova" ,"Monaco" , "Montenegro" , "Netherlands" ,   "North Macedonia" ,"Norway" , "Poland" , "Portugal" , "Romania" ,"Russia" ,"San Marino" , "Serbia" , "Slovakia" , "Slovenia" , "Spain" ,  "Sweden" ,"Switzerland" ,"Ukraine" ,"United Kingdom" , "Vatican City",
                    "Afghanistan" ,  "Algeria" ,"Armenia" ,"Azerbaijan" ,"Bahrain" ,"Egypt" ,  "Georgia" , "Iran" ,"Iraq" ,"Israel" , "Jordan" , "Kazakhstan" ,"Kuwait" , "Kyrgyzstan" , "Lebanon" ,"Libya" ,  "Morocco" ,"Oman" ,"Palestine" , "Qatar" ,  "Saudi Arabia" , "Sudan" ,  "Syria" ,  "Tajikistan" ,"Tunisia" ,"Turkey" , "Turkmenistan" , "United Arab Emirates", "Uzbekistan" ,"Yemen"
                ])
         .range(["#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA","#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA","#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA" ,"#20B2AA",
                 "#4169E1" ,"#4169E1" ,"#4169E1" ,"#4169E1" ,"#4169E1" ,"#4169E1" ,"#4169E1" ,"#4169E1" ,"#4169E1" ,"#4169E1" ,"#4169E1" ,"#4169E1" ,"#4169E1" ,"#4169E1" ,"#4169E1" ,"#4169E1" ,"#4169E1","#4169E1" ,"#4169E1",
                 "#CD5C5C" ,"#CD5C5C" ,"#CD5C5C" ,"#CD5C5C" ,"#CD5C5C" ,"#CD5C5C" ,"#CD5C5C" ,"#CD5C5C" ,"#CD5C5C" ,"#CD5C5C" ,"#CD5C5C" ,"#CD5C5C" ,"#CD5C5C" ,"#CD5C5C" ,"#CD5C5C" ,"#CD5C5C" ,"#CD5C5C","#CD5C5C" ,"#CD5C5C" ,"#CD5C5C" ,"#CD5C5C" ,"#CD5C5C" ,"#CD5C5C" ,"#CD5C5C" ,"#CD5C5C" ,"#CD5C5C" ,"#CD5C5C" ,"#CD5C5C" ,"#CD5C5C" ,"#CD5C5C" ,"#CD5C5C" ,"#CD5C5C" ,"#CD5C5C" ,"#CD5C5C","#CD5C5C" ,"#CD5C5C" ,"#CD5C5C" ,"#CD5C5C" ,"#CD5C5C" ,"#CD5C5C" ,"#CD5C5C" ,"#CD5C5C" ,"#CD5C5C",
                 "#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32","#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32","#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32" ,"#32CD32","#32CD32",
                 "#FF8C00" ,"#FF8C00" ,"#FF8C00" ,"#FF8C00" ,"#FF8C00" ,"#FF8C00" ,"#FF8C00" ,"#FF8C00" ,"#FF8C00" ,"#FF8C00" ,"#FF8C00" ,"#FF8C00" ,"#FF8C00" ,"#FF8C00" ,"#FF8C00" ,"#FF8C00" ,"#FF8C00","#FF8C00" ,"#FF8C00" ,"#FF8C00" ,"#FF8C00" ,"#FF8C00" ,"#FF8C00" ,"#FF8C00" ,"#FF8C00" ,"#FF8C00" ,"#FF8C00" ,"#FF8C00" ,"#FF8C00" ,"#FF8C00"
                   //,"#5F9EA0","#008B8B","#008080", //cyan
            //         "#4169E1", "#0000FF", "#0000CD", //blue
            //         "#CD5C5C", "#DC143C", "#B22222", "#FF0000", //red
            //         "#32CD32","#32CD32","#00FF00","#228B22", // green
        ...
        const x14 = d3.axisLeft(y.get('Mortality rate, under-5 (Mean per 1,000 live births)')).tickFormat(d3.format("d"));
...
function hover_in1() {
    ...
    variables.shift() // remove variable "country"
    ...
    div.html("<strong>" + event.target.__data__.year + "</strong>" + "<br/>" +
            ...
            "<strong>" + event.target.__data__.country + "</strong>"
        ...
        // "Conflicts (mean): " + event.target.__data__["Conflicts (Average % of country participation in the country)"] + "<br/>" +         
